...
class TestPyplate(unittest.TestCase):
	...
	def test_BYTE_extract(self):
		...
		self.assertTrue(
			unpack("c", str(self.test_byte))[0] == extracted_values[0]["value"]
		)
	...
	def test_DOUBLE_extract(self):
		...
		self.assertTrue(
			unpack("d", str(self.test_double))[0] == extracted_values[0]["value"]
		)
